"""AutoRest main application setup code."""
...
# Application imports
from app_autorest.exception import (
    BadRequestException,
    ForbiddenException,
    NotFoundException,
...
from app_autorest.service import Service
from app_autorest.model import db, Model, AutomapModel
from app_autorest.admin import CustomAdminView
from flask_admin import Admin
from flask_httpauth import HTTPBasicAuth

# Augment app_autorest's Model class with the Automap and Flask-SQLAlchemy model
# classes
auth = HTTPBasicAuth()
...
def get_app(
    ...
    *database_uri*.
    ...
    """
    app = Flask('app_autorest')
    app.config['SQLALCHEMY_DATABASE_URI'] = database_uri
    app.config['app_autorest_READ_ONLY'] = read_only
...
def register_model(cls, admin=None):
    ...
    :param cls: Class deriving from :class:`app_autorest.models.Model`
    """
