...
# Application imports
from app_autorest.exception import NotFoundException, BadRequestException
from app_autorest.model import db
from app_autorest.decorators import etag, validate_fields
...
class Service(MethodView):
    ...
    #: The app_autorest.model.Model-derived class to expose
    __model__ = None
    ...
    def _resource(self, resource_id):
        """Return the ``app_autorest.model.Model`` instance with the given
        *resource_id*.
